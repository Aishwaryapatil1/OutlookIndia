  ...
  return (
    ...
    <div className='mainlook'>
      <div className='firstlook'>
        <img src="https://imgnew.outlookindia.com/uploadimage/library/16_9/16_9_5/IMAGE_1655544259.webp" alt="" />
     <p>A train coach set on fire during a protest against the 'Agnipath' scheme in Bihar   -Getty Images</p><br />
     <NavLink className={"navlink"} style={{fontSize:"45px", fontWeight:"Dark"}} to={`/`}>Why Is Agnipath Scheme Facing The Heat?</NavLink><br />
     <p>The fact that 75% of 'Agniveers' will be discharged from their services after four years, among other features, has left millions of armed forces’ aspirants angry about the government's new recruitment scheme.</p>
